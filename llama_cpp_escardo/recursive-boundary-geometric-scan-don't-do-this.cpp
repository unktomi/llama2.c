/*
 * QUARANTINED: this is the llama.cpp port of the falsified recursive boundary
 * geometric-barycenter scorer.  It must not be used as evidence for joint
 * projection quality.  Correct candidates were present in measured supports
 * but were ranked below malformed or incorrect continuations.
 */
